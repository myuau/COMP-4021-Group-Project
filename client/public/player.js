...
const Player = function(ctx, x, y, gameArea) {
    ...
    const sequences = {
        ...
        idleLeft:  { x: 24, y: 231, width: 22.5, height: 57, count: 1, timing: 2000, loop: false },
        idleUp:    { x: 79, y: 231, width: 26, height: 55, count: 1, timing: 2000, loop: false },
        idleRight: { x: 2, y: 231, width: 22.5, height: 56, count: 1, timing: 2000, loop: false },
        idleDown:  { x: 50, y:  231, width: 23, height: 56, count: 1, timing: 2000, loop: false },

        /* Moving sprite sequences for facing different directions */
        moveLeft:  { x: 2, y: 58, width: 36, height: 57, count: 6, timing: 50, loop: true },
        moveUp:    { x: 4, y: 173.2, width: 36, height: 61, count: 9, timing: 100, loop: true },
        moveRight: { x: 2.2, y: 0, width: 36, height: 57, count: 6, timing: 50, loop: true },
        moveDown:  { x: 2, y: 115.2, width: 36, height: 59, count: 8, timing: 100, loop: true }
    };
    ...
    sprite.setSequence(sequences.idleDown)
          ...
          .useSheet("player_sprite/sprite-sheet.png");
